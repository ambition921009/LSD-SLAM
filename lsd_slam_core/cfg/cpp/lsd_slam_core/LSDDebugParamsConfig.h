...
//#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(LSDDebugParamsConfig::AbstractParamDescriptionConstPtr(new LSDDebugParamsConfig::ParamDescription<bool>("plotTracking", "bool", 0, "Plot final tracking residual. Nice Visualization of whats going on, however drastically decreases tracking speed.", "", &LSDDebugParamsConfig::plotTracking)));
//#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      __param_descriptions__.push_back(LSDDebugParamsConfig::AbstractParamDescriptionConstPtr(new LSDDebugParamsConfig::ParamDescription<bool>("plotTracking", "bool", 0, "Plot final tracking residual. Nice Visualization of whats going on, however drastically decreases tracking speed.", "", &LSDDebugParamsConfig::plotTracking)));
//#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
