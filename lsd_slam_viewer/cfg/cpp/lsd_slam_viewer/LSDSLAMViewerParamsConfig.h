...
//#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(LSDSLAMViewerParamsConfig::AbstractParamDescriptionConstPtr(new LSDSLAMViewerParamsConfig::ParamDescription<double>("scaledDepthVarTH", "double", 0, "log10 of threshold on points variance, in the respective keyframes scale. ", "", &LSDSLAMViewerParamsConfig::scaledDepthVarTH)));
//#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      __param_descriptions__.push_back(LSDSLAMViewerParamsConfig::AbstractParamDescriptionConstPtr(new LSDSLAMViewerParamsConfig::ParamDescription<double>("scaledDepthVarTH", "double", 0, "log10 of threshold on points variance, in the respective keyframes scale. ", "", &LSDSLAMViewerParamsConfig::scaledDepthVarTH)));
//#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(LSDSLAMViewerParamsConfig::AbstractParamDescriptionConstPtr(new LSDSLAMViewerParamsConfig::ParamDescription<double>("absDepthVarTH", "double", 0, "log10 of threshold on points variance, in absolute scale.", "", &LSDSLAMViewerParamsConfig::absDepthVarTH)));
//#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
      __param_descriptions__.push_back(LSDSLAMViewerParamsConfig::AbstractParamDescriptionConstPtr(new LSDSLAMViewerParamsConfig::ParamDescription<double>("absDepthVarTH", "double", 0, "log10 of threshold on points variance, in absolute scale.", "", &LSDSLAMViewerParamsConfig::absDepthVarTH)));
//#line 274 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator.py"
